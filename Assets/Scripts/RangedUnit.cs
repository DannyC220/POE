...
using UnityEngine;
    ...
    System.Random r = new System.Random();
        ...
        //ranged unit inherits from base class unit
        ...
        //to string method handles print of ranged unit position and hp
        ...
        public override void NewPos()
        {
            ...
            {
                move = r.Next(1, 5);
                //checks to see if unit cannot move up
                if (YPosition == 0 && move == 1)
                    valid = false;
                //checks to see if unit cannot move right
                else if (XPosition == 19 && move == 2)
                    valid = false;
                //checks to see if unit cannot move left
                else if (YPosition == 19 && move == 3)
                    valid = false;
                //checks to see if unit cannot move down
